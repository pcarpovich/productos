...
def create_app():
    ...
    from stock_control_app.project.reports.routes import reports_bp
    app.register_blueprint(reports_bp) # url_prefix is in blueprint definition

    @app.route('/')
    def hello_world():
        return 'Hello, World! <a href="/products/">View Products</a> | <a href="/deposits/">View Deposits</a> | <a href="/operators/">View Operators</a> | <a href="/clients/">View Clients</a> | <a href="/movements/add">Record Movement</a> | <a href="/reports/current_stock">Current Stock Report</a>'

    # Removed the /debug_stock_levels route
